/* ============================================================================
   CRISC  ::  quizEngine.js  —  ENGINE  (assessment + PBQ runtime)
   The question bank (content/quiz1..8.js) and PBQ database (content/pbqs.js)
   load before this file and populate CRISC.questions / CRISC.pbqs.
   ...
   read from CRISC.exam — the single source of truth — never re-literaled.
   ========================================================================== */
(function () {
  "use strict";
  ...
  /* ===========================================================================
     ...
     Persists two things across every quiz/mock session (localStorage via APP):
       crisc.objstats.v1 = { "1.2": {c, n}, ... }   per-objective accuracy
       crisc.missed.v1   = { "D4-071": 1, ... }      questions answered wrong
  ...
  /* ===========================================================================
     ...
     Length and duration come from CRISC.exam (single source of truth).
     =========================================================================== */
