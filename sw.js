...
var CACHE = "examsite-crisc-v1"; /* per-site name: all sites share one origin on GitHub Pages */
var SCOPE = "examsite-crisc-"; /* only prune THIS site's old caches */
var LEGACY = ["examsite-v1"];
